!function (t) {
    ...
    "use strict";
    e = e || {};
    var n = e.tagName || "span", i = null != e.classPrefix ? e.classPrefix : "char", o = 1, s = function (t) {
        for (var e = t.parentNode, s = t.nodeValue, a = s.length, r = -1; ++r < a;) {
            var h = document.createElement(n);
            i && (h.className = i + o, o++), h.appendChild(document.createTextNode(s[r])), e.insertBefore(h, t)
        }
        e.removeChild(t)
    };
    return function a(t) {
        for (var e = [].slice.call(t.childNodes), n = e.length, i = -1; ++i < n;) a(e[i]);
        t.nodeType === Node.TEXT_NODE && s(t)
    }(t), t
}), function (t) {
    function e(e, n, i, o) {
        var s = e.text().split(n), a = "";
    ...
    t.easing.jswing = t.easing.swing, t.extend(t.easing, {
        def: "easeOutQuad", swing: function (e, n, i, o, s) {
    ...
    function e(e) {
        var a = e || window.event, r = h.call(arguments, 1), c = 0, l = 0, u = 0, f = 0;
    ...
    i.DATA_KEY = "draptouch", i.DEFAULTS = {
        ...
        if ((!this.lastMove || new Date > new Date(this.lastMove.getTime() + this.throttleTimeout)) && (this.lastMove = new Date, this.mouseDown && (this.xpos || this.ypos))) {
            var o = e - this.xpos, s = n - this.ypos;
            if (this.threshold > 0) {
            ...
            var r = this.scrollLeft(), h = this.scrollTop();
        ...
        var e = (this.$el, this.el), n = this, i = n.settings;
        ...
        return this.each(function () {
            var o = t(this), s = o.data(i.DATA_KEY), a = t.extend({}, i.DEFAULTS, o.data(), "object" == typeof e && e);
    ...
    "use strict";
    Object.defineProperty(t, "__esModule", {value: !0}), "function" != typeof Object.assign && Object.defineProperty(Object, "assign", {
        value: function (t) {
    ...
    var e = function (t) {
        ...
        t.prototype = {
            defaults: {
                ...
                var n = this.getTouchCenter(this.getTouches(t)), i = e / this.lastScale;
                ...
                var e = this.getTouches(t)[0], i = this.zoomFactor > 1 ? 1 : this.options.tapZoomFactor,
                    o = this.zoomFactor, s = function (t) {
                ...
                var e = this.el.offsetWidth * this.getInitialZoomFactor() * this.zoomFactor,
                    ...
                    o = n - this.getContainerY() + this.options.verticalPadding, s = Math.max(i, 0), a = Math.max(o, 0),
                    r = Math.min(i, 0) - this.options.horizontalPadding,
                    h = Math.min(o, 0) - this.options.verticalPadding;
                return {x: Math.min(Math.max(t.x, r), s), y: Math.min(Math.max(t.y, h), a)}
                ...
                var t = this.sanitizeOffset(this.offset), e = {x: this.offset.x, y: this.offset.y}, n = function (n) {
                    this.offset.x = e.x + n * (t.x - e.x), this.offset.y = e.y + n * (t.y - e.y), this.update()
                }.bind(this);
                this.animate(this.options.animationDuration, n, this.swing)
            }, zoomOutAnimation: function () {
                if (1 !== this.zoomFactor) {
                    var t = this.zoomFactor, e = 1, n = this.getCurrentZoomCenter(), i = function (i) {
                ...
                var t = this.offset.x - this.initialOffset.x, e = -1 * this.offset.x - t / (1 / this.zoomFactor - 1),
                    n = this.offset.y - this.initialOffset.y, i = -1 * this.offset.y - n / (1 / this.zoomFactor - 1);
                return {x: e, y: i}
            }, getTouches: function (t) {
                var e = this.container.getBoundingClientRect(),
                    n = document.documentElement.scrollTop || document.body.scrollTop,
                    i = document.documentElement.scrollLeft || document.body.scrollLeft, o = e.top + n, s = e.left + i;
                return Array.prototype.slice.call(t.touches).map(function (t) {
                    return {x: t.pageX - s, y: t.pageY - o}
                })
            }, animate: function (t, e, n, i) {
                var o = (new Date).getTime(), s = function () {
                    if (this.inAnimation) {
                        var a = (new Date).getTime() - o, r = a / t;
                ...
                this.updatePlaned || (this.updatePlaned = !0, window.setTimeout(function () {
                    ...
                    var e = this.getInitialZoomFactor() * this.zoomFactor, n = -this.offset.x / e,
                        i = -this.offset.y / e,
                        o = "scale3d(" + e + ", " + e + ",1) translate3d(" + n + "px," + i + "px,0px)",
                        s = "scale(" + e + ", " + e + ") translate(" + n + "px," + i + "px)", a = function () {
        ...
        var s = function (t, e) {
            var n = null, i = 0, o = null, s = null, a = function (t, i) {
                if (n !== t) {
                    if (n && !t) switch (n) {
                        case"zoom":
                            e.handleZoomEnd(i);
            ...
            t.addEventListener("touchstart", function (t) {
                ...
                if (e.enabled && !e.isDoubleTap) {
                    if (d) r(t), n && u(t), s = h(t.touches); else {
                        switch (n) {
                            case"zoom":
    ...
    function n(t, e) {
        for (var n = t.length; --n;) if (Math.round(+t[n]) !== Math.round(+e[n])) return !1;
        return !0
    }
    ...
    function a(t, n) {
        ...
        var o = this.$elem = e(t);
        this.$set = n.$set && n.$set.length ? n.$set : o, this.$doc = e(t.ownerDocument || r), this.$parent = o.parent(), this.parent = this.$parent[0], this.isSVG = d.test(t.namespaceURI) && "svg" !== t.nodeName.toLowerCase(), this.panning = !1, this._buildTransform(), this._transform = e.cssProps.transform ? e.cssProps.transform.replace(f, "-$1").toLowerCase() : "transform", this._buildTransition(), this.resetDimensions();
        var s = e(), c = this;
    ...
    var r = t.document, h = "__pz__", c = Array.prototype.slice, l = /trident\/7./i, u = function () {
            if (l.test(navigator.userAgent)) return !1;
            var t = r.createElement("input");
            return t.setAttribute("oninput", "return"), "function" == typeof t.oninput
        }(), f = /([A-Z])/g, d = /^http:[\w\.\/]+svg$/, p = "(\\-?\\d[\\d\\.e-]*)", g = "\\,?\\s*",
        m = new RegExp("^matrix\\(" + p + g + p + g + p + g + p + g + p + g + p + "\\)$");
    return o.prototype = {
        x: function (t) {
            var e = t instanceof s, n = this.elements, i = t.elements;
        ...
        constructor: a, instance: function () {
            ...
            var t = this.elem, n = t.getBoundingClientRect(), i = Math.abs(this.scale);
            this.dimensions = {
                width: n.width,
                height: n.height,
                ...
                margin: {top: e.css(t, "marginTop", !0) * i || 0, left: e.css(t, "marginLeft", !0) * i || 0}
            }
        }, reset: function (t) {
            t = i(t);
            ...
            return t ? this.setTransform(t) : (t = e.style(i, "transform"), !this.isSVG || t && "none" !== t || (t = e.attr(i, "transform") || "none")), "none" === t || m.test(t) || this.setTransform(t = e.css(i, "transform")), t || "none"
            ...
            if (!this.disabled) {
                ...
                var i = +t[0], o = "undefined" != typeof n.contain ? n.contain : this.options.contain;
                if (o) {
                    var s = n.dims;
                    s || (this.resetDimensions(), s = this.dimensions);
                    var a, r, h, c = this.container, l = s.width, u = s.height, f = c.width, d = c.height, p = f / l,
                        g = d / u;
                    ...
                    var m = (u - d) / 2 + s.border.top, v = (u - d) / 2 - s.border.top - s.border.bottom;
            ...
            if (this._transition) for (var n = t || !this.options.transition ? "none" : this._transition, i = this.$set, o = i.length; o--;) e.style(i[o], "transition") !== n && e.style(i[o], "transition", n)
        }, pan: function (t, e, n) {
            ...
            if (!i.disableZoom) {
                var a = !1, r = i.matrix || this.getMatrix(), h = +r[0];
                ...
                if (c && !i.disablePan) {
                    this.resetDimensions();
                    var l = i.dims = this.dimensions, u = c.clientX, f = c.clientY;
                    this.isSVG || (u -= l.width / h / 2, f -= l.height / h / 2);
                    var d = new s(u, f, 1), p = new o(r), g = this.parentOffset || this.$parent.offset(),
                        m = new o(1, 0, g.left - this.$doc.scrollLeft(), 0, 1, g.top - this.$doc.scrollTop()),
                        v = p.inverse().x(m.inverse().x(d)), y = t / r[0];
            ...
            var n = this.$parent;
            n.length && !e.nodeName(this.parent, "body") && (t = {overflow: "hidden"}, "static" === n.css("position") && (t.position = "relative"), n.css(t))
        }, _resetStyle: function () {
            this.$elem.css({cursor: "", transition: ""}), this.$parent.css({overflow: "", position: ""})
        }, _bind: function () {
            var t = this, n = this.options, i = n.eventNamespace,
                o = "mousedown" + i + " pointerdown" + i + " MSPointerDown" + i, s = "touchstart" + i + " " + o,
                r = "touchend" + i + " click" + i + " pointerup" + i + " MSPointerUp" + i, h = {}, c = this.$reset,
                l = this.$zoomRange;
            if (e.each(["Start", "Change", "Zoom", "Pan", "End", "Reset"], function () {
                ...
                var f = this.$zoomIn, d = this.$zoomOut;
            ...
            if (!this.panning) {
                var o, s, a, h, c, l, u, f, d = this, p = this.options, g = p.eventNamespace, m = this.getMatrix(),
                    v = m.slice(0), y = +v[4], w = +v[5], b = {matrix: m, animate: "skip"}, x = t.type;
                ...
                var M = function (t) {
                    ...
                    if (t.preventDefault(), i = t.touches || t.originalEvent.touches, _(t, i), i) {
                        if (2 === i.length) {
                            var n = d._getMiddle(i), o = d._getDistance(i) - a;
    ...
    t.attrFn = t.attrFn || {};
    var i = "ontouchstart" in window, o = {
        tap_pixel_range: 5,
    ...
    t.isTouchCapable = function () {
        ...
        setup: function () {
            var e, i, s, a, r = this, h = t(r), c = null, l = !1;
            h.on(o.startevent, function u(n) {
                ...
                var u = Date.now(), d = h.data("lastTouch") || u + 1, p = u - d;
        ...
        setup: function () {
            var e = this, i = t(e), s = null, a = null, r = {x: 0, y: 0};
        ...
        setup: function () {
            var e, i, s = this, a = t(s), r = !1, h = null, c = {x: 0, y: 0};
            a.on(o.startevent, function l(t) {
                ...
                var l = t.originalEvent.targetTouches ? t.originalEvent.changedTouches[0].pageX : t.pageX,
                    f = t.originalEvent.targetTouches ? t.originalEvent.changedTouches[0].pageY : t.pageY, d = c.x - l,
                    p = c.y - f;
        ...
        setup: function () {
            ...
            function n(e) {
                ...
                if (l.y > u.y && l.y - u.y > p && (i = "swipeup"), l.x < u.x && u.x - l.x > d && (i = "swiperight"), l.y < u.y && u.y - l.y > p && (i = "swipedown"), l.x > u.x && l.x - u.x > d && (i = "swipeleft"), void 0 != i && h) {
                    ...
                    var g = e.originalEvent, m = {
                        ...
                        time: Date.now(),
                        target: e.target
                    }, v = Math.abs(s.position.x - m.position.x), y = Math.abs(s.position.y - m.position.y), w = {
                        startEvnt: s,
                        endEvnt: m,
            ...
            function i(e) {
                ...
                if (r.data("callee3", i), c) {
                    var a = r.data("xthreshold"), l = r.data("ythreshold"),
                    ...
                    var g = Math.abs(s.position.x - p.position.x), m = Math.abs(s.position.y - p.position.y), v = {
                        startEvnt: s,
                        endEvnt: p,
            ...
            var s, a = this, r = t(a), h = !1, c = !1, l = {x: 0, y: 0}, u = {x: 0, y: 0};
    ...
    var s, a, r, h, c, l = t(window), u = {0: !0, 180: !0};
    if (o.orientation_support) {
        var f = window.innerWidth || l.width(), d = window.innerHeight || l.height(), p = 50;
        h = f > d && f - d > p, c = u[window.orientation], (h && c || !h && !c) && (u = {"-90": !0, 90: !0})
    }
    t.event.special.orientationchange = s = {
        ...
        var t = !0, e = document.documentElement;
