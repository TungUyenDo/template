...
function ResizeWindows() {
    var e = ($(window).height() > $(window).width(), $(window).height() <= $(window).width()), t = $(window).width(),
        a = $(window).height(), i = t / 2400, o = a / 1300, n = t / 1550;
    if (440 >= t) var r = t / 1150; else var r = t / 1300;
    if (440 >= t) var s = t / 1200; else var s = t / 1300;
    if ($("#news-page").length && $(".grid").each(function (e, t) {
        var a = $(t).find(".group").length;
        a >= 2 && $(".group").addClass("after-group")
    }), 1100 >= t) $(".scrollA, .scrollB,.scrollC").length && $(".scrollA, .scrollB,.scrollC").getNiceScroll().remove(), $(".news-text img, .pic-library img, .box-image img").addClass("zoom-pic"), 1 == e ? ($(".facilities-map").css({height: $(".facilities-bg").height() * n}), $(".facilities-bg").scale(n), $(".apartment-map").css({height: $(".apartment-bg").height() * n}), $(".apartment-bg").scale(n)) : ($(".facilities-map").css({height: $(".facilities-bg").height() * r}), $(".facilities-bg").scale(r), $(".apartment-map").css({height: $(".apartment-bg").height() * s}), $(".apartment-bg").scale(s)), 440 >= t ? ($(".apartment-bg").css({
        left: t / 2 - 1200,
        ...
        if (a / t > .54 ? ($(".facilities-bg,  .apartment-bg").scale(o), $(".apartment-bg").css({
            left: t / 2 - 1200,
            top: a / 2 - 700
        })) : ($(".facilities-bg,  .apartment-bg").scale(i), $(".apartment-bg").css({
            left: t / 2 - 1200,
            top: a / 2 - 680
        })), $(".facilities-map, .apartment-map").height(a), t > 1100 && 750 > a ? $(".facilities-bg").css({
            left: t / 2 - 1200,
            top: a / 2 - 720
        }) : $(".facilities-bg").css({left: t / 2 - 1200, top: a / 2 - 700}), $(".content-house").length) {
...
function NavAni() {
    ...
    var t = new TimelineLite({delay: .5, onComplete: e});
    t.staggerTo($(".open-click span"), .4, {opacity: 1, ease: Power0.easeOut}, -.1, .15)
}

function MenuWave() {
    var e = new TimelineLite({paused: !1});
    Paths = $(".animation path"), $(Paths).each(function (t, a) {
...
function DrawLoad() {
    var e = $(".load-present");
    Paths = $(e).find("path"), $(Paths).each(function () {
        var e = this.getTotalLength();
        isIE9 || isIE10 || isIE11 ? ($(this).css({"stroke-dasharray": e + " " + e}), $(this).css({
            "stroke-dashoffset": e,
            "stroke-dasharray": e + " " + e
        }), $(this).stop().animate({"stroke-dashoffset": 0}, 1800, "linear", function () {
...
function Done() {
    ResizeWindows(), SlidePicture(), $(window).width() > 1100 && BoxSlide(), $(".title-page > h1").lettering("words").children("span").lettering().children("span").lettering(), $(".nav li a, .open-click, .close-click small, .title-main h2, .title-pic h3").lettering(), $(".container").stop().animate({opacity: 1}, 300, "linear", function () {
        $(".loadicon").addClass("blur"), requestAnimationFrame(HideMask), $(".loadicon").stop().animate({
            scale: .5,
            opacity: 0
        }, 1e3, "linear", function () {
            ContentLoad(), cancelAnimationFrame(HideMask), $(".loadicon").remove()
        })
    }), $(".grid-item-bg").length && $(window).width() > 1100 && BgEffect(), $(".viewer").length && $(window).width() > 1100 && ScaleMap(), Loadpic()
}
...
var ua = navigator.userAgent, match = ua.match("MSIE (.)"), versions = match && match.length > 1 ? match[1] : "unknown",
    ...
    isDesktop = 0 != $(window).width() && !isTouchDevice, IEMobile = ua.match(/IEMobile/i), isIE9 = /MSIE 9/i.test(ua),
    isIE10 = /MSIE 10/i.test(ua), isIE11 = !(!/rv:11.0/i.test(ua) || IEMobile),
    isEge = /Edge\/12./i.test(navigator.userAgent),
    isOpera = !!window.opr && !!opr.addons || !!window.opera || ua.indexOf(" OPR/") >= 0,
    isFirefox = "undefined" != typeof InstallTrigger, isIE = !!document.documentMode,
    isEdge = !isIE && !!window.StyleMedia && !isIE11, isChrome = !!window.chrome && !!window.chrome.webstore,
    ...
    AndroidVersion = parseFloat(ua.slice(ua.indexOf("Android") + 8)), Version = ua.match(/Android\s([0-9\.]*)/i), ios,
    android, blackBerry, UCBrowser, Operamini, firefox, windows, smartphone, tablet, touchscreen, all, isMobile = {
        ios: function () {
...
if (isTouchDevice && null !== isMobile.all) var TouchLenght = !0; else if (isMobile.tablet && isFirefox || isMobile.smartphone && isFirefox) var TouchLenght = !0; else var TouchLenght = !1;
isMobile.Operamini && alert("Please disable Data Savings Mode");
var iOS = isMobile.ios, Loadx = 0, Paths = {}, timex, News = 0, Details = 0, doWheel = !0, doTouch = !0,
    windscroll = $(document).scrollTop(), timer, httpserver = $(".httpserver").text(),
    httptemplate = $(".httptemplate").text(), Expand = function e() {
        $("html, body").addClass("no-scroll"), $(".navigation").addClass("show"), $(".nav-click").removeClass("show-line"), $(".youtube-video iframe").length && $(".pause-button").trigger("click"), $(".wave-ani").hasClass("in-play") && $(".stop-svg").trigger("click");
        var t = new TimelineLite;
        TweenLite.set($(".nav li a span"), {opacity: 0}), $(".nav li a span").each(function (e, t) {
            TweenLite.to($(t), .6, {
                opacity: 1, delay: RanDom(.5, .75), ease: Power0.easeOut, onComplete: function () {
            ...
            t.to($(a), 1, {attr: {d: i}, opacity: 1, ease: Power2.easeInOut}, -.1, .55)
        }), t.staggerTo($(".open-click span"), .3, {
            opacity: 0,
            ease: Power0.easeOut
        }, -.1, .15), t.staggerTo($(".close-click small span"), .4, {
            opacity: 1,
            ease: Power0.easeOut
        }, -.1, .15), t.call(function () {
            $(".nav-click").addClass("active")
        }, null, null, .6), cancelAnimationFrame(e)
    }, Collapse = function t() {
        ...
        e.staggerTo($(".open-click span"), .4, {
            ...
            ease: Power0.easeOut,
            onComplete: function () {
                $(".navigation").removeClass("show"), $("html, body").removeClass("no-scroll"), $(".show-text .wave-ani").length && $(".play-svg").trigger("click"), $(".youtube-video iframe").length && $('.group-central[data-name="video-home"]').hasClass("show-text") && $(".play-button").trigger("click")
            }
        }), $(".gradient path").each(function (t, a) {
            var i = $(a).attr("pathhide");
            e.to($(a), .8, {attr: {d: i}, opacity: 0, delay: .4, ease: Power2.easeInOut}, -.1, .55)
        ...
        if ($(window).width() > 1100) {
            ...
            $(".box-svg path").each(function (e, a) {
                ...
                t.to($(a), 1.6, {attr: {d: i}, opacity: 1, ease: Power4.easeInOut}, RanDom(.6, .95))
            })
        }
        ...
        if ($(window).width() > 1100) {
            ...
            $(".box-svg path").each(function (e, a) {
                ...
                t.to($(a), .6, {attr: {d: i}, opacity: 0, ease: Power4.easeInOut}, .1, .15)
            })
        }
    };
if ($(".animation").length && (MenuWave(), $(".stop-wave").trigger("click")), $(".wave-ani").length) {
    var AniBG = function (e) {
        ...
        Paths = $(".in-play[data-id='" + e + "'] path"), $(Paths).each(function (e, a) {
            var i = $(a).attr("pathdata");
...
var BgEffect = function () {
    var e = document.querySelector(".grid-item-bg"), t = Array.from(e.querySelectorAll("img")),
        a = document.querySelector(".grid-item-bg canvas");
    a ? (bgAni.previous({hover: e.dataset.hover}), setTimeout(function () {
        $(".grid-item-bg canvas").addClass("show"), requestAnimationFrame(function () {
            bgAni.next({hover: e.dataset.hover})
        })
    }, 150)) : bgAni = new hoverEffect({
        parent: e,
        intensity: .3,
        speedIn: 1.2,
        speedOut: 0,
        ...
        // displacementImage: httptemplate + "/images/bg5.jpg"
    })
}, HideMask = function () {
    var e = $(".shape-svg path").attr("pathdata"), t = new TimelineLite({paused: !1});
    t.to($(".shape-svg path"), RanDom(.1, .6), {
        attr: {d: e},
        repeat: -1,
        yoyo: !0,
        ease: Power2.easeInOut
    }), TweenLite.to($(".mask"), 2, {
        y: "-100%", ease: Quad.easeOut, onComplete: function () {
            t.pause()
        }
    })
};
if ($(document).ready(function () {
    if (ResizeWindows(), $(".loadicon").hasClass("loading") || ($(".loadicon").show(), $(".loadicon").addClass("loading"), DrawLoad()), isIE10 || isIE11 ? $("body").addClass("is-IE") : isEdge ? $("body").addClass("is-Edge") : iOS ? $("body").addClass("is-IOS") : isSafari ? $("body").addClass("is-Safari") : isChrome && $("body").addClass("is-Chrome"), $(".box-nav li").length <= 1 && ($(".box-nav").css({display: "none"}), $(".box-slider").addClass("single")), $(window).width() > 1100 && $("img.map").length && $(".map").maphilight(), $(".youtube-video, .player").length) {
...
var WEBGL = {
    ...
    var a = "\nvarying vec2 vUv;\nvoid main() {\n  vUv = uv;\n  gl_Position = projectionMatrix * modelViewMatrix * vec4( position, 1.0 );\n}\n",
        ...
        o = e.parent, n = e.displacementImage, r = e.image1, s = e.image2, l = t(e.intensity1, e.intensity, 1),
        d = t(e.intensity2, e.intensity, 1), c = t(e.angle, Math.PI / 4), u = t(e.angle1, c), h = t(e.angle2, 3 * -c),
        p = t(e.speedIn, e.speed, 1.6), m = t(e.speedOut, e.speed, 1.2), f = t(e.hover, !0),
    ...
    var k = new THREE.ShaderMaterial({
        uniforms: {
            ...
            disp: {type: "t", value: C}
        }, vertexShader: a, fragmentShader: i, transparent: !0, opacity: 1
    }), E = new THREE.PlaneBufferGeometry(o.offsetWidth, o.offsetHeight, 1), P = new THREE.Mesh(E, k);
    v.add(P);
    var O = function () {
        var e = "mouseenter", t = "mouseleave";
...
!function (e, t) {
    ...
    }(), !a && !t) return void (e.fn.maphilight = function () {
        return this
    });
    if (a) {
        d = function (e) {
        ...
        var p = function (e, t, a, o, n) {
            if (o = o || 0, n = n || 0, e.beginPath(), "rect" == t) e.rect(a[0] + o, a[1] + n, a[2] - a[0], a[3] - a[1]); else if ("poly" == t) for (e.moveTo(a[0] + o, a[1] + n), i = 2; i < a.length; i += 2) e.lineTo(a[i] + o, a[i + 1] + n); else "circ" == t && e.arc(a[0] + o, a[1] + n, a[2], 0, 2 * Math.PI, !1);
            e.closePath()
        };
        n = function (t, a, i, o) {
            ...
            if (o.shadow) {
                ...
                var r = 100 * t.width, s = 100 * t.height;
                ...
                var l = o.shadowFrom;
                l || (l = "outside" == o.shadowPosition ? "fill" : "stroke"), "stroke" == l ? (n.strokeStyle = "rgba(0,0,0,1)", n.stroke()) : "fill" == l && (n.fillStyle = "rgba(0,0,0,1)", n.fill()), n.restore(), "outside" == o.shadowPosition && (n.save(), p(n, a, i), n.globalCompositeOperation = "destination-out", n.fillStyle = "rgba(0,0,0,1);", n.fill(), n.restore())
            }
            n.save(), p(n, a, i), o.fill && (n.fillStyle = c(o.fillColor, o.fillOpacity), n.fill()), o.stroke && (n.strokeStyle = c(o.strokeColor, o.strokeOpacity), n.lineWidth = o.strokeWidth, n.stroke()), n.restore(), o.fade && e(t).css("opacity", 0).stop().animate({opacity: 1}, 300, "linear")
        }, r = function (e) {
        ...
        r = '<v:fill color="#' + o.fillColor + '" opacity="' + (o.fill ? o.fillOpacity : 0) + '" />', s = o.stroke ? 'strokeweight="' + o.strokeWidth + '" stroked="t" strokecolor="#' + o.strokeColor + '"' : 'stroked="f"', l = '<v:stroke opacity="' + o.strokeOpacity + '"/>', "rect" == a ? d = e('<v:rect name="' + n + '" filled="t" ' + s + ' style="zoom:1;margin:0;padding:0;display:block;position:absolute;left:' + i[0] + "px;top:" + i[1] + "px;width:" + (i[2] - i[0]) + "px;height:" + (i[3] - i[1]) + 'px;"></v:rect>') : "poly" == a ? d = e('<v:shape name="' + n + '" filled="t" ' + s + ' coordorigin="0,0" coordsize="' + t.width + "," + t.height + '" path="m ' + i[0] + "," + i[1] + " l " + i.join(",") + ' x e" style="zoom:1;margin:0;padding:0;display:block;position:absolute;top:0px;left:0px;width:' + t.width + "px;height:" + t.height + 'px;"></v:shape>') : "circ" == a && (d = e('<v:oval name="' + n + '" filled="t" ' + s + ' style="zoom:1;margin:0;padding:0;display:block;position:absolute;left:' + (i[0] - i[2]) + "px;top:" + (i[1] - i[2]) + "px;width:" + 2 * i[2] + "px;height:" + 2 * i[2] + 'px;"></v:oval>')), d.get(0).innerHTML = r + l, e(t).append(d)
    }, r = function (t) {
    ...
    e.fn.maphilight = function (i) {
        return i = e.extend({}, e.fn.maphilight.defaults, i), a || m || (e(window).ready(function () {
            ...
            var l, d, c, p, m, f, g;
            if (l = e(this), !u(this)) return window.setTimeout(function () {
                l.maphilight(i)
            }, 200);
            if (c = e.extend({}, i, e.metadata ? l.metadata() : !1, l.data("maphilight")), g = l.get(0).getAttribute("usemap"), g && (p = e('map[name="' + g.substr(1) + '"]'), l.is('img,input[type="image"]') && g && p.length > 0)) {
                if (l.hasClass("area")) {
                    var v = l.parent();
                    l.insertBefore(v), v.remove(), e(p).unbind(".maphilight")
                }
                d = e('<div class="map-background"></div>').css({backgroundImage: 'url("' + this.src + '")'}), c.wrapClass && (c.wrapClass === !0 ? d.addClass(e(this).attr("class")) : d.addClass(c.wrapClass)), l.before(d), t && l.css("filter", "Alpha(opacity=0)"), d.append(l), m = o(this), m.height = this.height, m.width = this.width, e(p).bind("alwaysOn.maphilight", function () {
                    f && r(f), a || e(m).empty(), e(p).find("area[coords]").each(function () {
                        var e, t;
                        t = h(this, c), t.alwaysOn && (!f && a && (f = o(l[0]), f.width = l[0].width, f.height = l[0].height, l.before(f)), t.fade = t.alwaysOnFade, e = s(this), a ? n(f, e[0], e[1], t, "") : n(m, e[0], e[1], t, ""))
                    })
